...
if settings.DEBUG:
    print("Running dynamodb and lambda locally")
    ...
    print("Running dynamodb in production mode...")
    print("If you're running locally you need to set DEBUG = True in settings.py")
